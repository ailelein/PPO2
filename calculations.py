...
def secrecyRate(guPos, GuNewTx, lsuPos, ljuPos, meuPos, mjuPos, ljunewTx, mjuTx):
    ...
    r_g_s = math.log2(1+ ((GuNewTx*chanGainGu_ser)/(mjuTx * chanGainMJ_ser + NoisePow)))
    r_g_e = math.log2(1+ ((GuNewTx*chanGainGu_eav)/(ljunewTx * cahnGainLJ_eav + NoisePow)))
