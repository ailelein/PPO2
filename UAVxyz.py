...
def train():
    ...
    while time_step <= max_training_timesteps:
        ...
        for t in range(1, max_ep_len + 1):
            ...
            state, reward, done, _, _, guinfo_copy, LSUPosHistory, odhistoryFull, secrecyrate_info, r_g_s_info, r_g_e_info = env.step1(action,guinfo_copy, LSUPosHistor,odhistoryFull  )
